...
namespace Wfm.App.BL
{
    public class DepartmentBL
    {
        ...
        public List<DepartmentMasterMetaData> GetDepartmentByCompanyId_Admin(Guid companyId,Guid BUILDING_ID)
        {
            return baseRepository.DepartmentRepo.GetDepartmentByCompanyId_Admin(companyId, BUILDING_ID);
        }
