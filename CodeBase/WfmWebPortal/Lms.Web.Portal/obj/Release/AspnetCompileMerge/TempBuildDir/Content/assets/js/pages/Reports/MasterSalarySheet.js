            ...
            success:
                function (response) {
                    ...
                    if (response != "") {
                        ...
                        html += '<th class="bold" colspan="58" style="text-align: center; font-size: 1.7rem; ">' + result.COMPANY_NAME + '</th>'
                        html += '</tr>'
                        html += '<tr style="background: #29c1c9;color:white;font-weight:400!important">'
                        html += '<th class="bold" colspan="58" style="text-align: center; font-size: 1.7rem; ">' + result.ADDRESS1 + '</th>'
                        html += '</tr>'
                        html += '<tr style="background: #29c1c9; color: white; font-weight: 400 !important;">';
                        html += '<th class="bold" colspan="58" style="text-align: center; font-size: 1.7rem; ">WORKERS SALARY SHEET FOR THE MONTH OF ' + MonthYear + '</th>';
                        html += '</tr>';
                        ...
                        html += '<td rowspan="2" class="bold">Actual PR Amount of PIB</td>'
                        html += '<td rowspan="2" class="bold">Total PR Amount of PIB (Admin)</td>'
                        html += '<td rowspan="2" class="bold">PR Payable Amount</td>'
                        html += '<td rowspan="2" class="bold">Actual Present days for PR Workers</td>'
                        html += '<td rowspan="2" class="bold">Actual Leave Taken of PIB Worker ' + MonthYear + '</td>' 
                        html += '<td rowspan="2" class="bold">Permission</td>' 
                        html += '<td rowspan="2" class="bold">Paid Days</td>'
                        html += '<td rowspan="2" class="bold">Paid Days_CW</td>'
                        html += '<td rowspan="2" class="bold">PD Salary_CW</td>'
                        html += '<td rowspan="2" class="bold">Earned Gross_CW</td>'
                        html += '<td rowspan="2" class="bold">Advance Annual Bonus_CW</td>'
                        html += '<td rowspan="2" class="bold">Difference Checking</td>'
                      ...
                      /*  html += '<td class="bold">Total Leave balance ' + MonthYear + '</td>'*/
                        ...
                        for (var i = 0; i < Cols.length; i++) {
                          ...
                          /*  if (EMPLOYMENT_TYPE == 2) {*/
                                html += '<td>' + data.ActualPRAmountofPIB + '</td>'
                                html += '<td>' + data.TotalPRAmountofPIB + '</td>'
                            ...
                            //    html += '<td>0</td>'
                            //}
                            html += '<td>' + data.ActualLeaveTakenofPIB + '</td>'
                            html += '<td>' + data.Permission + '</td>'
                            html += '<td>' + data.PaidDay + '</td>'
                            html += '<td>' + data.PaidDays_CW + '</td>'
                            html += '<td>' + data.PD_Salary_CW + '</td>'
                            html += '<td>' + data.EarnedGross_CW + '</td>'
                            html += '<td>' + data.AnnualBonus_CW + '</td>'
                            html += '<td>' + data.Difference_Checking_CW + '</td>'
