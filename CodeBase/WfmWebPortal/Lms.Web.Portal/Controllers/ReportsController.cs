...
namespace Lms.Web.Portal.Controllers
{
    ...
    public class ReportsController : Controller
    {
        ...
        public string Get_MasterSalary(string BUILDING_ID, string DEPT_ID, string SUBDEPT_ID, int WF_EMP_TYPE, int MONTH_ID, int YEAR_ID, int EMPLOYMENT_TYPE)
        {
         ...
         [HttpGet]
        public string Get_PIB_SUMMARY(string BUILDING_ID, string DEPT_ID, string SUBDEPT_ID, int WF_EMP_TYPE, int MONTH_ID, int YEAR_ID, int EMPLOYMENT_TYPE)
        {

            AttendanceDetails objCustomer = new AttendanceDetails();
            DLLReports objDB = new DLLReports(); //calling class DBdata
            string result = objDB.Get_MasterSalary("Proc_PIB_SUMMARY_SHEET", BUILDING_ID, DEPT_ID, SUBDEPT_ID, WF_EMP_TYPE, MONTH_ID, YEAR_ID, EMPLOYMENT_TYPE);
